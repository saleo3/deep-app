...
export class ProductService{
    ...
    constructor(
        ...
        @InjectRepository(ProductOrdersEntity) private readonly productOrderRepository: Repository<ProductOrdersEntity>
    ){}
    ...
    public async createOrders(order:any){
        ...
        return await this.productOrderRepository.findOneOrFail({where:{id:newOrder.id},relations:['product']});
    }
    ...
    public async updateOrder(order:any){
        ...
        try {
            await this.productOrderRepository
                ...
                .execute();
               orderToUpdate=await this.productOrderRepository
                .findOne({where:{id:order.id},relations:["product"]})
